import { AUDIT_SHEET_DEFINITIONS, AUDIT_SHEET_NAMES, CORE_SHEET_DEFINITIONS, CORE_SHEET_NAMES, DISPATCHER_SHEET_DEFINITIONS, DISPATCHER_SHEET_NAMES, ROUTER_SHEET_DEFINITIONS, ROUTER_SHEET_NAMES } from '../../src/contracts/core-sheet-schema.mjs';
...
export const DISPATCHER_CONFIG_TEMPLATE = Object.freeze(Object.fromEntries(DISPATCHER_SHEET_NAMES.map((sheetName) => [sheetName, Object.freeze({
  sheet_name: sheetName,
  columns: Object.freeze([...DISPATCHER_SHEET_DEFINITIONS[sheetName]]),
  rows: Object.freeze((fakeRows[sheetName] ?? []).map((entry) => Object.freeze({ ...entry }))),
})])));
