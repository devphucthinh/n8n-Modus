...
test('/help requests only the catalog and message tables it consumes', () => {
  assert.deepEqual(requiredSheetNames('/help'), ['CONFIG_ROLE', 'CONFIG_PERMISSION', 'CONFIG_USER_ROLE', 'CONFIG_ROLE_PERMISSION', 'CONFIG_TOPIC', 'CONFIG_LENH', 'EVENT_LOG']);
});
