...
const routerRows = {
  ...
  CONFIG_LENH: [
    ...
    ['CMD_NHAP_HANG', '/nhaphang', '/nhaphang', 'Ghi nhận nhập hàng', 'NHAP_HANG_WRITE', 'NHAP_HANG', 'WF08_V2_PURCHASE_INGESTION', '/nhaphang', '20', 'ACTIVE'],
    ['CMD_NHAP_BAN', '/nhapban', '/nhapban', 'Ghi nhận bán hàng', 'NHAP_BAN_WRITE', 'NHAP_BAN', 'WF09_V2_SALES_INGESTION', '/nhapban', '30', 'ACTIVE'],
    ['CMD_BAO_CAO', '/baocaobia', '/baocaobia', 'Xem báo cáo bia', 'BAO_CAO_READ', 'BAO_CAO', 'WF12_V2_REPORTING', '/baocaobia', '40', 'ACTIVE'],
